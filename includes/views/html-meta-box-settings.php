...
<table class="form-table">
    <tr>
        <th><label for="parser_method"><?php _e( 'Method', 'parser-manager' ); ?></label></th>
        <td>
...
<div class="test_parser">
    ...
    <div class="result_parser">
        <strong><?php _e( 'Result', 'parser-manager' ); ?>:</strong> <span id="result_value"></span>
    </div>
</div>